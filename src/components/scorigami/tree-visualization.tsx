// import { selectedNodePathAtom } from "@/store/scoreigami/node-path";
import {
  showCountAtom,
  // showGradientAtom,
  viewTypeAtom,
...
export const TreeVisualization = ({
  ...
  // const [showGradient] = useAtom(showGradientAtom);
  const [showCount] = useAtom(showCountAtom);
  // const [_, setSelectedNodePath] = useAtom(selectedNodePathAtom);
