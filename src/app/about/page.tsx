    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <p className="text-xl mb-12 text-center max-w-5xl mx-auto">
          Tennis Scorigami is an innovative (we think) project that explores
          unique tennis match scores. Inspired by the concept of scorigami in
          other sports, this project visualizes the occurrence of rare tennis
          scorelines in major tournaments around the world.
        </p>
