...
_SUPABASE_SERVICE_ROLE_KEY_TMP = os.getenv("SUPABASE_SERVICE_ROLE_KEY")
assert _SUPABASE_SERVICE_ROLE_KEY_TMP, "Supabase key is missing. Set it in the .env file."
SUPABASE_SERVICE_ROLE_KEY = _SUPABASE_SERVICE_ROLE_KEY_TMP
